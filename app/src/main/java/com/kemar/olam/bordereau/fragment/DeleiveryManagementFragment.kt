 ...
 * Use the [DeleiveryManagementFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DeleiveryManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DeleiveryManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DeleiveryManagementFragment().apply {
