 ...
 * Use the [OriginVerifFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OriginVerifFragment : Fragment() {
    ...
    override fun onCreateView(
       ...
       /* return inflater.inflate(R.layout.layout_loading_n_declaration, container, false)*/
    ...
    companion object {
         ...
         * @return A new instance of fragment OriginVerifFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OriginVerifFragment().apply {
