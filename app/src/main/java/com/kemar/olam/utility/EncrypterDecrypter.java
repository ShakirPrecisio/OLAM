...
public class EncrypterDecrypter {
    ...
    private static Context contextED;


    private String keyValue = "abSh756rnsgd75kABpq132xbgnkSH609";
    private String initializationVector = "IYWNMQBAWHBZCFQS";

    public EncrypterDecrypter(Context context) {
    ...
    public  String decrypt(String key, String initVector, String encrypted) {
        try {
            byte[] encData =HexStringToByteArray(encrypted);
            IvParameterSpec iv = new IvParameterSpec(initVector.getBytes("UTF-8"));
            SecretKeySpec skeySpec = new SecretKeySpec(key.getBytes("UTF-8"), "AES");
