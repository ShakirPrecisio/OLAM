...
@RealmClass
open class BodereuLogListing :RealmObject() {
    ...
    @SerializedName("loadingWagonFlag")
    @Expose
    private var loadingWagonFlag: String? = null
    ...
    fun getLoadingWagonFlag(): String? {
        return loadingWagonFlag
    }

    fun setLoadingWagonFlag(loadingWagonFlag: String?) {
        this.loadingWagonFlag = loadingWagonFlag
    }
