...
class DeliverdBordereuLogsAdapter  (val context : Context, val dataList: ArrayList<BodereuLogListing>, val commingFrom:String) : RecyclerView.Adapter<DeliverdBordereuLogsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, position: Int): ViewHolder {
        val v = LayoutInflater.from(viewGroup.context).inflate(R.layout.row_delivered_logs_details, viewGroup, false)
        return ViewHolder(v);
    }
