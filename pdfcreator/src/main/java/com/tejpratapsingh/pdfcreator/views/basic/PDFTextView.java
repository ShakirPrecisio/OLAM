...
public class PDFTextView extends PDFView implements Serializable {
    ...
    private static final float TEXT_SIZE_H2 = 6;
    private static final float TEXT_SIZE_H3 = 6;
    private static final float TEXT_SIZE_H4 = 6;
    private static final float TEXT_SIZE_P = 6;
    private static final float TEXT_SIZE_SMALL = 6;
