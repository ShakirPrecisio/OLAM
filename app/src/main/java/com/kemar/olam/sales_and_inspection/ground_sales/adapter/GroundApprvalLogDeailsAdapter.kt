...
class GroundApprvalLogDeailsAdapter (val context : Context, val dataList: ArrayList<BodereuLogListing>, val commingFrom:String) : RecyclerView.Adapter<GroundApprvalLogDeailsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, position: Int): ViewHolder {
        val v = LayoutInflater.from(viewGroup.context).inflate(R.layout.row_view_ground_approval_logs_liisting, viewGroup, false)
        return ViewHolder(v);
    }
